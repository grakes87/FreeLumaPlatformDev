...
export default async function BiblePage({ searchParams }: BiblePageProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center overflow-y-auto bg-gradient-to-br from-teal-900 via-teal-800 to-cyan-900 px-4 text-white">
      ...
      <div className="relative z-10 flex max-w-md flex-col items-center text-center">
        ...
        <div className="mb-10 rounded-xl border border-white/10 bg-white/5 px-6 py-5 backdrop-blur-sm">
          <p className="text-base leading-relaxed italic text-teal-100">
          ...
          <p className="mt-3 text-sm text-teal-300">Jeremiah 29:11</p>
        </div>

        {/* CTA Buttons */}
        <Link
          href={signupHref}
          className="mb-4 w-full rounded-xl bg-white px-8 py-3.5 text-center text-lg font-semibold text-teal-900 shadow-lg transition-transform hover:scale-[1.02] active:scale-[0.98]"
        >
          Get Started
        </Link>
