...
export function CommentBottomSheet({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // Force iOS Safari to fully reset viewport scroll offset
      window.scrollTo(0, 0);
  ...
  return createPortal(
    <div className="fixed inset-0 z-50">
      ...
      <div
        ref={sheetRef}
        className="fixed inset-x-0 bottom-0 z-10 flex max-h-[65vh] flex-col rounded-t-3xl border-t border-white/20 bg-white/10 shadow-[0_-8px_32px_rgba(0,0,0,0.3)] backdrop-blur-2xl transition-transform"
        style={{
