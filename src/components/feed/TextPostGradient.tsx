 ...
 */
const GRADIENTS = [
  'from-blue-900 via-indigo-800 to-purple-900',        // deep blue -> purple
  ...
  'from-slate-900 via-blue-900 to-indigo-900',          // midnight
  'from-rose-700 via-pink-600 to-purple-700',           // rose
  'from-cyan-700 via-teal-700 to-blue-800',             // ocean
  'from-violet-800 via-purple-700 to-indigo-800',       // royal purple
...
export function TextPostGradient({ text, postId }: TextPostGradientProps) {
  ...
  return (
    <div
      className={`flex h-full w-full items-center justify-center bg-gradient-to-br ${gradientClass} px-8`}
    >
      <p
