...
must_haves:
  truths:
    ...
    - "Voice messages play back with waveform visualization"
...
<task type="auto">
  ...
  <action>
    ...
    2. Create `src/components/chat/VoicePlayback.tsx`:
       ...
       - Waveform: static bars (can't analyze actual audio without downloading), use duration-proportional placeholder bars
       - Progress: as audio plays, fill waveform bars proportionally
