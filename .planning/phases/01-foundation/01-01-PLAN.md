...
```bash
npm install sequelize@6 mysql2 jose bcryptjs @react-oauth/google google-auth-library apple-signin-auth swiper srt-parser-2 html-to-image next-themes lucide-react react-easy-crop @aws-sdk/client-s3 @aws-sdk/s3-request-presigner sharp react-hook-form @hookform/resolvers zod date-fns date-fns-tz nodemailer

npm install -D @types/bcryptjs @types/nodemailer sequelize-cli
```
